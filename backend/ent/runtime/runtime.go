...
func init() {
	...
	// apikeyDescIsClaudeProxyKey is the schema descriptor for is_claude_proxy_key field.
	apikeyDescIsClaudeProxyKey := apikeyFields[5].Descriptor()
	// apikey.DefaultIsClaudeProxyKey holds the default value on creation for the is_claude_proxy_key field.
	apikey.DefaultIsClaudeProxyKey = apikeyDescIsClaudeProxyKey.Default.(bool)
